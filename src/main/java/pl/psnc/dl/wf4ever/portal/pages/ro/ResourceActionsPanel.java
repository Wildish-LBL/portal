...
public class ResourceActionsPanel extends Panel {
    ...
    public ResourceActionsPanel(String id, final IModel<Resource> model) {
        ...
        updateButton = new AuthenticatedAjaxEventButton("update", form, null, UpdateClickedEvent.class);
        form.add(updateButton);
        form.add(new AuthenticatedAjaxEventButton("delete", form, null, ResourceDeleteClickedEvent.class));
        form.add(new AuthenticatedAjaxEventButton("move", form, null, ResourceMoveClickedEvent.class));
