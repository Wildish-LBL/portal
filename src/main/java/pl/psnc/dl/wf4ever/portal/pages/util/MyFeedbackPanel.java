 ...
 * view. The maximum number of messages to show can be set with setMaxMessages().
 * 
	...
	implements IFeedback
{
	...
	/**
	 * Search messages that this panel will render, and see if there is any message of
	 * level ERROR or up. This is a convenience method; same as calling
	...
	/**
	 * Search messages that this panel will render, and see if there is any message of the
	 * given level.
	 * 
	 * @param level
	...
	/**
	 * @return Model for feedback messages on which you can install filters and other
	 *         properties
	 */
	...
	/**
	 * @param maxMessages
	 *            The maximum number of feedback messages that this feedback panel should
	 *            show at one time
	 * 
	 * @return FeedbackPanel this.
	 */
	 ...
	 * @param message
	 *            the message
	 * @return the css class; by default, this returns feedbackPanel + the message level,
	 *         eg 'feedbackPanelERROR', but you can override this method to provide your
	 *         own
	 */
