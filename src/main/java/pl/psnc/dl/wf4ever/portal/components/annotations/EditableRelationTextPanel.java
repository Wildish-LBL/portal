 ...
 * 
 */
public class EditableRelationTextPanel extends Panel {

    /** Logger. */
    @SuppressWarnings("unused")
    private static final Logger LOG = Logger.getLogger(EditableRelationTextPanel.class);
     ...
     */
    public EditableRelationTextPanel(String id, Annotable annotable) {
