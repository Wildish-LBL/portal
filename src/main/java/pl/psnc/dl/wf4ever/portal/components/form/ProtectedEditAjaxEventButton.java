...
public class ProtectedEditAjaxEventButton extends AjaxEventButton {

    /** id. */
    private static final long serialVersionUID = 4715910030458646408L;

    /** Logger. */
    private static final Logger LOG = Logger.getLogger(ProtectedEditAjaxEventButton.class);
     ...
     */
    public ProtectedEditAjaxEventButton(String id, Form<?> form, IModel<? extends Annotable> annotableModel,
