...
public class MyExpImportService {
	 ...
	 */
	public static User retrieveMyExpUser(Token accessToken, OAuthService service) throws OAuthException, JAXBException {
		User myExpUser;
	...
	private static User createMyExpUserModel(String xml) throws JAXBException {
	...
	private static class ImportThread extends Thread {
		 ...
		 * @throws Exception
		 */
		private void createWorkspace(String workspaceId) throws Exception {
		...
		private List<Pack> getPacks(List<PackHeader> packHeaders) throws OAuthException, JAXBException {
		 ...
		 * @throws Exception
		 */
		private void importPacks(List<Pack> packs, String roName) throws JAXBException, Exception {
			for (Pack pack : packs) {
		 ...
		 * @throws Exception
		 */
		private void importInternalPackItem(Pack pack, InternalPackItemHeader packItemHeader) throws JAXBException,
				Exception {
		...
		private SimpleResource importSimpleResource(SimpleResourceHeader res, String roName, String path,
				Class<? extends SimpleResource> resourceClass) throws Exception {
		...
		private void importResourceMetadata(Resource res, String filename, String roName, String path) throws Exception {
		 ...
		 * @throws Exception
		 */
		private void createRO(String id) throws Exception {
