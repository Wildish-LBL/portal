...
public class RDFFormat implements Serializable {
     ...
     * @param mimeTypes
     *            The MIME type(s) of the file format, e.g. <tt>text/plain</tt> for theplain text files. The first item
     *            in the list is interpreted as the default MIME type for the format. The supplied list should contain
    ...
    /**
     * Checks if the specified MIME type matches the RDFFormat's default MIME type. The MIME types are compared ignoring
     * upper/lower-case differences.
     * 
     * @param mimeType
     *            The MIME type to compare to the RDFFormat's default MIME type.
     * @return <tt>true</tt> if the specified MIME type matches the RDFFormat's default MIME type.
     */
    ...
    /**
     * Checks if specified MIME type matches one of the RDFFormat's MIME types. The MIME types are compared ignoring
     * upper/lower-case differences.
     * 
     * @param mimeType
     *            The MIME type to compare to the RDFFormat's MIME types.
     * @return <tt>true</tt> if the specified MIME type matches one of the RDFFormat's MIME types.
     */
    ...
    /**
     * Checks if the specified file name extension matches the RDFFormat's default file name extension. The file name
    ...
    /**
     * Checks if the RDFFormat's file extension is equal to the specified file extension. The file extensions are
     * compared ignoring upper/lower-case differences.
     * 
     * @param extension
     *            The file extension to compare to the RDFFormat's file extension.
     * @return <tt>true</tt> if the specified file extension is equal to the RDFFormat's file extension.
     */
    ...
    /**
     * Tries to match the specified file name with the file extensions of the supplied file formats. This method will
     ...
     * @return An RDFFormat object if the MIME type was recognized, or <tt>null</tt> otherwise.
    ...
    /**
     * Tries to determine the appropriate RDF file format based on the a MIME type that describes the content type. The
     * supplied fallback format will be returned when the MIME type was not recognized.
     * 
     * @param mimeType
     *            A file name.
     ...
     * @param fileName
     *            A file name.
     * @return An RDFFormat object if the file extension was recognized, or <tt>null</tt> otherwise.
    ...
    /**
     * Tries to determine the appropriate RDF file format based on the extension of a file name. The supplied fallback
     * format will be returned when the file name extension was not recognized.
     * 
     * @param fileName
     *            A file name.
     ...
     * @param formatName
     *            A format name.
     * @return The RDF format whose name matches the specified name, or <tt>null</tt> if there is no such format.
     */
